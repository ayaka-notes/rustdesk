...
// `ayaka-v1.4.6` release — verified against the GitHub API, not guessed.
...
export const RELEASE_TAG = "ayaka-v1.4.6";
...
export const RELEASES: PlatformGroup[] = [
  {
    ...
    assets: [
      {
        label: "Installer (MSI)",
        filename: "rustdesk-1.4.6-x86_64.msi",
        arch: "x86_64",
        url: dl("rustdesk-1.4.6-x86_64.msi"),
        size: "23.4 MB",
        notes: "推荐:静默安装、自动启动后台服务",
      },
      {
        label: "Portable (EXE)",
        filename: "rustdesk-1.4.6-x86_64.exe",
        arch: "x86_64",
        url: dl("rustdesk-1.4.6-x86_64.exe"),
        size: "23.0 MB",
        notes: "免安装,适合临时 / U 盘场景",
      },
      {
        label: "32-bit (Sciter)",
        filename: "rustdesk-1.4.6-x86-sciter.exe",
        arch: "x86",
        url: dl("rustdesk-1.4.6-x86-sciter.exe"),
        size: "11.2 MB",
  ...
  },
  {
    ...
    assets: [
      {
        label: "Apple Silicon",
        filename: "rustdesk-1.4.6-aarch64-aarch64.dmg",
        arch: "aarch64",
        url: dl("rustdesk-1.4.6-aarch64-aarch64.dmg"),
        size: "24.9 MB",
        notes: "首次打开:右键 → 打开,允许未知开发者",
      },
      {
        label: "Intel",
        filename: "rustdesk-1.4.6-x86_64-x86_64.dmg",
        arch: "x86_64",
        url: dl("rustdesk-1.4.6-x86_64-x86_64.dmg"),
        size: "31.1 MB",
      },
    ],
  },
    ...
    assets: [
      {
        ...
        filename: "rustdesk-1.4.6-x86_64.deb",
        arch: "x86_64",
        url: dl("rustdesk-1.4.6-x86_64.deb"),
        size: "22.1 MB",
        notes: "sudo apt install ./rustdesk-1.4.6-x86_64.deb",
      },
      {
        label: "Debian / Ubuntu (ARM64)",
        filename: "rustdesk-1.4.6-aarch64.deb",
        arch: "aarch64",
        url: dl("rustdesk-1.4.6-aarch64.deb"),
        size: "20.5 MB",
      },
      {
        label: "Fedora / RHEL (rpm)",
        filename: "rustdesk-1.4.6-0.x86_64.rpm",
        arch: "x86_64",
        url: dl("rustdesk-1.4.6-0.x86_64.rpm"),
        size: "29.8 MB",
      },
      {
        label: "AppImage (通用)",
        filename: "rustdesk-1.4.6-x86_64.AppImage",
        arch: "x86_64",
        url: dl("rustdesk-1.4.6-x86_64.AppImage"),
        size: "81.4 MB",
  ...
  },
  {
    ...
    assets: [
      {
        label: "Universal APK",
        filename: "rustdesk-1.4.6-universal.apk",
        arch: "universal",
        url: dl("rustdesk-1.4.6-universal.apk"),
        size: "67.6 MB",
        notes: "包含多种架构,体积稍大但兼容性最好",
      },
      {
        label: "ARM64 APK",
        filename: "rustdesk-1.4.6-aarch64.apk",
        arch: "aarch64",
        url: dl("rustdesk-1.4.6-aarch64.apk"),
        size: "25.4 MB",
      },
    ],
  },
  {
    ...
    assets: [
      {
        label: "IPA(未签名,需自签)",
        filename: "rustdesk-1.4.6-unsigned.ipa",
        arch: "aarch64",
        url: dl("rustdesk-1.4.6-unsigned.ipa"),
        size: "22.9 MB",
